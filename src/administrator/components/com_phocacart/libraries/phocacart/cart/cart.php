...
class PhocacartCart
{
	...
	// Products which not more exit (or their attributes/options) are removed
	...
	*/
	...
	public function addPaymentCosts($paymentId = 0)
	{
		...
		elseif (isset($this->shipping['costs']['id']) && (int) $this->shipping['costs']['id'] > 0)
		{
