	...
	public function checkCoupon($basicCheck = 0, $id = 0, $catid = 0, $quantity = 0, $amount = 0)
	{
		...
		if (!empty($this->coupon))
		{
			...
			if (isset($this->coupon['available_quantity']))
			{
				...
				elseif ((int) $this->coupon['available_quantity'] > 0
			...
			if (isset($this->coupon['available_quantity_user']))
			{
				...
				elseif ((int) $this->coupon['available_quantity_user'] > 0
			...
			if (isset($this->coupon['total_amount']))
			{
				...
				elseif ($this->coupon['total_amount'] > 0 && $amount < $this->coupon['total_amount'])
				{
			...
			if (isset($this->coupon['quantity_from']))
			{
				...
				elseif ((int) $this->coupon['quantity_from'] > 0 &&  (int) $quantity < (int) $this->coupon['quantity_from'])
				{
