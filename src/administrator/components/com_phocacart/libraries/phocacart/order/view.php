...
class PhocacartOrderView
{
	...
	public static function getTrackingLink($common)
	{
		...
		elseif (isset($common->shippingtrackinglink) && $common->shippingtrackinglink != '' && isset($common->tracking_number) && $common->tracking_number != '')
		{
	...
	public static function getTrackingDescription($common)
	{
		...
		elseif (isset($common->shippingtrackingdescription) && $common->shippingtrackingdescription != '')
		{
